...
➡ 키워드를 확장하여 문장으로 작성, 내용을 더 추가하기로 결정
➡ 8가지 유형으로 분류 기준을 세울지 16가지로 조합할지 3주차 회의 때 재논의하기로 
- 직접 분류하여 샘플을 생성할 때, 성인 도서의 경우 내용 파악이 어려움
- 따라서 6 ~ 10세(미취학 아동 ~ 초등학교 저학년)을 대상으로 세우는 것이 적절 (필요 시 초등학교 고학년까지)
➡ 대상을 저학년까지로 설정할지, 고학년까지로 설정할지 3주차 회의 때 논하기로 결정
```
</details><br>

<h2>:three: 3주차</h2>
<details>
<summary>1. MBTI에 따른 도서 분류 기준 최종본 도출</summary><br>
    
```
- 10월 18일(화) ZOOM을 통해 최종본 도출 회의 진행
```
</details>
