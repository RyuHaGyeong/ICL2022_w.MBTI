...
➡ 키워드는 8가지로 도출하지만, 책에는 16가지로 태깅하기로 결정 (정확도가 올라갈 것이라 판단)
```
</details><br>

<h2>:four: 4 & 5주차</h2>
<details>
<summary>1. MBTI 유형별 선호 도서 & 추천 도서 기준 도출</summary><br>
    
```
- 두 가지 표를 생성함에 있어서 각자의 의견이 자신의 지난 주차 키워드와 상이할 것으로 예상
- 11월 2일(수) 각자 두 가지 기준 및 의견을 깃허브에 업로드
- 11월 3일(목) 생각이 겹치는 키워드 취한 후 상이한 키워드 조정
- 자세한 설명을 위해 키워드를 문장으로 풀어내며 서술형 기준 생성
- 도출된 기준에 따른 선호 도서와 추천 도서 분류 태깅은 6주차에 진행할 예정
```
</details>
<details>
<summary>2. 주간 보고 피드백 및 수정 사항</summary><br>
